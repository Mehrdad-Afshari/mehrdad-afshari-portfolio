        ...
        <div className="grid w-full items-center gap-12 lg:grid-cols-2">
          ...
          <div>
            <p className="mb-4 text-sm font-medium uppercase tracking-[0.25em] text-blue-600 dark:text-blue-400">
              {t("AI Developer · Software & Database Developer")}
            </p>
            ...
            <h1 className="text-4xl font-bold leading-[1.1] tracking-tight sm:text-5xl lg:text-6xl">
              ...
              <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
                {locale === "de" ? "Software & KI." : "Software & AI."}
              </span>
            </h1>

            <p className="mt-8 max-w-xl text-lg leading-8 text-gray-600 dark:text-gray-400">
              {t(
                "I’m Mehrdad Afshari, an MSc Computer Science student at the University of Rostock, Germany, with 13+ years of experience in software development, databases, web development, and enterprise applications.",
              )}
            </p>
          ...
          <div className="relative mx-auto w-full max-w-md overflow-hidden rounded-[2rem] border border-black/10 bg-white shadow-2xl shadow-black/10 dark:border-white/10 dark:bg-white/5 dark:shadow-black/30">
            <div className="relative aspect-[4/5]">
              <Image
                ...
                alt={t(
                  "Mehrdad Afshari — AI Developer and MSc Computer Science student",
                )}
                fill
                priority
